...
public class SystemTestActivity extends Activity {
    ...
    protected void onResume() {
        ...
        gestureDetector = new GestureDetector(this, new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {
                super.onLongPress(e);
                Toast.makeText(SystemTestActivity.this, "被长按了", Toast.LENGTH_SHORT).show();
                StartandPause();
            }
    ...
    private void getRadiopath() {
        ...
        if (radioInfos != null && radioInfos.size() > 0) {//按照视频列表播放
            ...
            Toast.makeText(SystemTestActivity.this, "视频列表为空", Toast.LENGTH_SHORT).show();
        }
        setButtonstate();
    }
            ...
            public void onCompletion(MediaPlayer mp) {
                if(radioInfos!=null) {
                    if ((position < (radioInfos.size() - 1))) {
                        Toast.makeText(SystemTestActivity.this, "即将播放下一个视频", Toast.LENGTH_SHORT).show();
                        PlayNextitem();
                    } else {
                        Toast.makeText(SystemTestActivity.this, "没有下一个视频了！！！", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void startVatamio() {
        Toast.makeText(SystemTestActivity.this, "万能解码", Toast.LENGTH_SHORT).show();
        ...
        if (radioInfos != null && radioInfos.size() > 0) {
            if (radioInfos.size() == 1) {//如果只有一个
                ...
                if (position == 0) {
                    ...
                    Toast.makeText(SystemTestActivity.this, "这是最后一个视频", Toast.LENGTH_SHORT).show();
                    next.setBackgroundResource(R.drawable.btn_next_gray);
                    next.setEnabled(false);
    ...
    private class BattorychangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(Intent.ACTION_BATTERY_OKAY)) {//当电池充满时
                Toast.makeText(SystemTestActivity.this, "电池已充满，请放心使用", Toast.LENGTH_SHORT).show();
            } else if (intent.getAction().equals(Intent.ACTION_BATTERY_LOW)) {
                Toast.makeText(SystemTestActivity.this, "电池电量低，请充电", Toast.LENGTH_SHORT).show();
            }
